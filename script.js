...
// =====================================================================
// DATA KUPONŮ (Celkem 30 kuponů roztříděných do kategorií)
// =====================================================================
const coupons = [
  // --- SPECIÁLNÍ KATEGORIE ---
  {
      ...
      if (!isUsed) {
        if (coupon.id === "nekonecna_laska") {
          btn.addEventListener("click", () => {
            launchHearts(); // Speciální srdíčková animace
          });
        } else {
...
// Běžné konfety pro standardní kupony
...
// Srdíčková animace pro nekonečný kupon
